...
void make_window() {
   ...
   win->begin();      
     ...
     // Fl_Input*  Weight = new Fl_Input(110, 400, 250, 30, "&Weight"); //child 8 : 7th widget
...
void Add_cb( Fl_Widget* o , void* ) {
  string Name, Model_Number, Cost_s, Description, Image, Max_Power_s, Weight_s;
  double Cost, Max_Power, Weight;
